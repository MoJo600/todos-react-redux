...
import { CompleteTodo, DeleteTodo } from '~/app/containers/Todos/actions';
...
export class TodoItem extends React.Component<ITodoItemProps, ITodoItemProps> {
  ...
  toggleCompleteStatus = () => {
    this.props.todo.id && this.props.completeTodo(this.props.todo.id);
  };

  removeTodo = () => {
    this.props.todo.id && this.props.removeTodo(this.props.todo.id);
  };
